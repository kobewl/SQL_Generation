...
import static com.sql.generation.constant.UserConstant.ADMIN_ROLE;
import static com.sql.generation.constant.UserConstant.USER_LOGIN_STATE;
...
import com.sql.generation.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "wangliang";
    ...
    public User userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        System.out.println("user login——开始");
        // 1. 校验
